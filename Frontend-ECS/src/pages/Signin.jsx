...
function Signin() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const res = await fetch("https://new-rep-uw0m.onrender.com/api/v1/users/login", {
                method: "POST",
    ...
    return (
        <div className="mb-5">
            ...
            <p className="text-center pt-4">Don't have an Account <a href="/sign-up" className="text-blue-400">Sign-Up</a></p>
        </div>
    );
}
