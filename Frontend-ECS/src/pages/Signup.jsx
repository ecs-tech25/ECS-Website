...
function Signup() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const res = await fetch("https://new-rep-uw0m.onrender.com/api/v1/users/register", {
                method: "POST",
                headers: {
    ...
    return (
        <div className="mb-5 ">
            ...
            >
                ...
                <p className="text-center pt-4 text-white">Already have an Account <a href="/sign-in" className="text-blue-400">Sign-In</a></p>
            </form>
        </div>
        </div>
    );
